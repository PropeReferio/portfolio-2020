...
export const testimonials = [
    `Highly adaptable and ready to learn. That’s what comes to mind when
    ...
    `Working with a self-starter like Bo has been so refreshing.
...
export const authors = [
    `Andy Malkin, Senior Fullstack Engineer, Chainstarters`,
    `Arjun Srivastava, Software Engineer, Cloud Cafe Tech`,
    `Arjun Srivastava, Software Engineer, Cloud Cafe Tech`,
  ]
